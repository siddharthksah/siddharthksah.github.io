...
Last month at Quark, our table held two machines: [the submarine](https://siddharthksah.github.io/posts/2017/02/vandubbi/), and a [3D scanner](https://en.wikipedia.org/wiki/3D_scanning) built mostly out of 3D printed parts. This post is about the scanner, and about the part of the project the kit documentation never mentions, which is everything after the assembly.
