...
![Sequential dispatch pays the sum of all model latencies; thread-pool fan-out pays only the slowest model](/images/posts/deepsafe/fanout-latency.png){: loading="lazy" decoding="async"}
...
![Ensemble AUC and expected calibration error per modality: image 0.9967 and 0.0096, audio 0.9565 and 0.0132, video 0.7366 and 0.0219](/images/posts/deepsafe/ensemble-metrics.png){: loading="lazy" decoding="async"}
