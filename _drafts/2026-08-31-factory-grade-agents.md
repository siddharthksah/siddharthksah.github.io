...
The honest answer starts with what classical automation is. All of it, from relay logic to the most modern SCADA stack, executes situations a person enumerated in advance. Inside the enumerated space it is fast, deterministic, and close to unbeatable, and factory-grade agents should leave that space alone.
