...
Off hours, I like to contribute to [open source](https://github.com/siddharthksah){:target="_blank"}, over-engineer my homelab, and fix strangers' appliances at [Repair Kopitiam](https://repairkopitiam.sg/){:target="_blank"}. Away from screens, I play badminton and table tennis, and go for the occasional run. I am trying to track the books I read on [Goodreads](https://www.goodreads.com/user/show/34940770-siddharth-sah){:target="_blank"}.
...
I've been lucky to wander through these, and luckier to have called three countries home.
